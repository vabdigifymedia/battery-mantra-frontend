...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Privacy policy for Battery Mantra." },
    ],
  }),
    ...
    <div className="bg-background pb-20">
      ...
      <Container size="md" className="mt-12">
        <div className="prose prose-slate dark:prose-invert prose-lg max-w-none space-y-8">
          ...
          <p>
            This Privacy Policy relates solely to the information collection and use practices of our web site located at www.batterymantra.com and its related links (this "Website"). We recognize that many visitors and users of this Website are concerned about the information they provide to us, and how we treat that information. This Privacy Policy, which may be updated from time to time, has been developed to address those concerns.
          </p>
          ...
          <section>
            <h2>1. Changes to Privacy Policy</h2>
            <p>
          ...
          <section>
            <h2>2. Types of Information Collected and Uses of Collected Information</h2>
            <p>
            ...
            <p>
              <strong>Non-Personally Identifiable Information:</strong> Non-Personally Identifiable Information is information that does not identify a specific End User. This type of information may include things like the Uniform Resource Locator ("URL") of the website you visited before coming to our Website, the URL of the website you visit after leaving our Website, the type of browser you are using and your Internet Protocol ("IP") address.
            </p>
            <p>
          ...
          <section>
            <h2>3. Release of Personally Identifiable Information</h2>
            <p>
          ...
          <section>
            <h2>4. Release of Non-Personally Identifiable Information</h2>
            <p>
          ...
          <section>
            <h2>8. Privacy Policies of Third Party Websites</h2>
            <p>
            ...
            <p>
              Battery Mantra reserves the right to save the data when clicking the call button. Once you click on the button, you can make a call to the battery mantra directly. Similarly, on click you are able to open the call option as well as you can open the Whats App chat also. We send an SMS to the backend when you click on the call or Whats App option.
            </p>
          </section>
        </div>
      </Container>
